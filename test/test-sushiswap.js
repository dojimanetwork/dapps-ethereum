...
const TestSushiswapLiquidity = artifacts.require("TestSushiswapLiquidity");

contract("TestSushiswapLiquidity", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    contract = await TestSushiswapLiquidity.new();
