...
contract("TestCompoundEth", (accounts) => {
    ...
    it("should supply and redeem", async () => {
        let before = await snapshot(testCompound, web3, cToken)
        ...
        console.log(`eth balance of test contract ${before.eth}`)
        console.log(`c token balance ${before.cToken}`)
        console.log(`eth balance in ${accounts[0]} ${before.accountBalance}`)
        ...
        console.log(`eth balance of test contract ${after.eth}`)
        console.log(`c token balance ${after.cToken}`)
        console.log(`eth balance in ${accounts[0]} ${after.accountBalance}`)
